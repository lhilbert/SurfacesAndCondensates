...
sourceDirectories = { ...
	'/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_05Sep24/repeat1/Amphiphile/',...
    '/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_05Sep24/repeat1/Blind/',...
    '/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_05Sep24/repeat1/Control/',...
    '/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_05Sep24/repeat2/Amphiphile/',...
    '/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_05Sep24/repeat2/Blind/',...
    '/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_05Sep24/repeat2/Control/',...
    '/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_29Aug24/Amphiphile/',...
    '/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_29Aug24/Blind/',...
    '/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_29Aug24/Control/',...
    '/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_16Sep24/Amphiphile/',...	
	'/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_16Sep24/Blind/',...
    '/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_16Sep24/Control/'...
    '/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_16Sep24/High_Amphiphile/',...	
	'/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_16Sep24/High_Blind/',...
    '/Volumes/My_Passport/DNA_SurfaceCondensation/Nanomotifs_Amphiphiles_with_Surfaces_16Sep24/High_Control/'...
    };
...
extractTargetFolder = 'ExtractedStacks_Amphiphile';
...
condLabels = {...
	'Amphiphile (R1)','Blind (R1)','Control (R1)',...
    'Amphiphile (R2)','Blind (R2)','Control (R2)',...
    'Amphiphile (R3)','Blind (R3)','Control (R3)',...
    'Amphiphile (R4)','Blind (R4)','Control (R4)',...
    'Amphiphile High','Blind High','Control High'...
	};
